...
public class Yay extends AppCompatActivity {
    ...
    private AdView yayAdview;
    private InterstitialAd mInterstitialAd;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_yay);
        yayAdview = findViewById(R.id.yayAdView);
    ...
    public void istek(){
        ...
        dialog.show();
        Call<Bilgiler> yayBilgiList= ManagerAll.getInstance().yayBilgileri();
        yayBilgiList.enqueue(new Callback<Bilgiler>() {
            @Override
            public void onResponse(Call<Bilgiler> call, Response<Bilgiler> response) {
                if (response.isSuccessful()) {
                    ...
                    models.add(new Model(R.drawable.yay, "Yay Burcu Günlük  Genel Yorum", "" + genel));
                    models.add(new Model(R.drawable.yay, "Yay Burcu Günlük Aşk & İlişkiler Yorumu", "" + ask));
                    models.add(new Model(R.drawable.yay, "Yay Burcu Maddi Durum Yorumu", "" + maddi));
                    models.add(new Model(R.drawable.yay, "Yay Burcu Günlük Kariyer Yorumu", "" + kariyer));
