...
public class Oglak extends AppCompatActivity {
    ...
    private AdView oglakAdview;
    private InterstitialAd mInterstitialAd;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_oglak);
        oglakAdview = findViewById(R.id.oglakAdView);
        AdRequest adRequest = new AdRequest.Builder().build();
        oglakAdview.loadAd(adRequest);
    ...
    public void istek(){
        ...
        dialog.show();
        Call<Bilgiler> oglakBilgiList= ManagerAll.getInstance().oglakBilgileri();
        oglakBilgiList.enqueue(new Callback<Bilgiler>() {
            @Override
            public void onResponse(Call<Bilgiler> call, Response<Bilgiler> response) {
                if (response.isSuccessful()) {
                    ...
                    models.add(new Model(R.drawable.oglak, "Oğlak Burcu Günlük  Genel Yorum", "" + genel));
                    models.add(new Model(R.drawable.oglak, "Oğlak Burcu Günlük Aşk & İlişkiler Yorumu", "" + ask));
                    models.add(new Model(R.drawable.oglak, "Oğlak Burcu Maddi Durum Yorumu", "" + maddi));
                    models.add(new Model(R.drawable.oglak, "Oğlak Burcu Günlük Kariyer Yorumu", "" + kariyer));
