...
public class Yengec extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        yengecAdview = findViewById(R.id.yengecAdView);
        AdRequest adRequest = new AdRequest.Builder().build();
        yengecAdview.loadAd(adRequest);
    ...
    public void istek() {
        ...
        dialog.show();
        Call<Bilgiler> yengecBilgiList = ManagerAll.getInstance().yengecBilgileri();
        yengecBilgiList.enqueue(new Callback<Bilgiler>() {
            @Override
            public void onResponse(Call<Bilgiler> call, Response<Bilgiler> response) {
                if (response.isSuccessful()) {
                    ...
                    models.add(new Model(R.drawable.yengec, "Yengeç Burcu Günlük  Genel Yorum", "" + genel));
                    models.add(new Model(R.drawable.yengec, "Yengeç Burcu Günlük Aşk & İlişkiler Yorumu", "" + ask));
                    models.add(new Model(R.drawable.yengec, "Yengeç Burcu Maddi Durum Yorumu", "" + maddi));
                    models.add(new Model(R.drawable.yengec, "Yengeç Burcu Günlük Kariyer Yorumu", "" + kariyer));
