...
public class Akrep extends AppCompatActivity {
    ...
    public void istek(){
        ...
        dialog.show();
        Call<Bilgiler> akrepBilgiList= ManagerAll.getInstance().akrepBilgileri();
        akrepBilgiList.enqueue(new Callback<Bilgiler>() {
            @Override
            public void onResponse(Call<Bilgiler> call, Response<Bilgiler> response) {
                if (response.isSuccessful()) {
                    ...
                    models.add(new Model(R.drawable.akrep, "Akrep Burcu Günlük  Genel Yorum", "" + genel));
                    models.add(new Model(R.drawable.akrep, "Akrep Burcu Günlük Aşk & İlişkiler Yorumu", "" + ask));
                    models.add(new Model(R.drawable.akrep, "Akrep Burcu Maddi Durum Yorumu", "" + maddi));
                    models.add(new Model(R.drawable.akrep, "Akrep Burcu Günlük Kariyer Yorumu", "" + kariyer));
