...
public class Basak extends AppCompatActivity {
    ...
    private AdView basakAdview;
    private InterstitialAd mInterstitialAd;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_basak);
        basakAdview = findViewById(R.id.basakAdView);
        AdRequest adRequest = new AdRequest.Builder().build();
        basakAdview.loadAd(adRequest);
    ...
    public void istek() {
        ...
        dialog.show();
        Call<Bilgiler> basakBilgiList = ManagerAll.getInstance().basakBilgileri();
        basakBilgiList.enqueue(new Callback<Bilgiler>() {
            @Override
            public void onResponse(Call<Bilgiler> call, Response<Bilgiler> response) {
                if (response.isSuccessful()) {
                    ...
                    models.add(new Model(R.drawable.basak, "Başak Burcu Günlük  Genel Yorum", "" + genel));
                    models.add(new Model(R.drawable.basak, "Başak Burcu Günlük Aşk & İlişkiler Yorumu", "" + ask));
                    models.add(new Model(R.drawable.basak, "Başak Burcu Maddi Durum Yorumu", "" + maddi));
                    models.add(new Model(R.drawable.basak, "Başak Burcu Günlük Kariyer Yorumu", "" + kariyer));
