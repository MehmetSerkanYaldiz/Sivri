...
public class Kova extends AppCompatActivity {
    ...
    private AdView kovaAdview;
    private InterstitialAd mInterstitialAd;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_kova);
        kovaAdview = findViewById(R.id.kovaAdView);
        AdRequest adRequest = new AdRequest.Builder().build();
        kovaAdview.loadAd(adRequest);
    ...
    public void istek(){
        ...
        dialog.show();
        Call<Bilgiler> kovaBilgiList= ManagerAll.getInstance().kovaBilgileri();
        kovaBilgiList.enqueue(new Callback<Bilgiler>() {
            @Override
            public void onResponse(Call<Bilgiler> call, Response<Bilgiler> response) {
                if (response.isSuccessful()) {
                    ...
                    models.add(new Model(R.drawable.kova, "Kova Burcu Günlük  Genel Yorum", "" + genel));
                    models.add(new Model(R.drawable.kova, "Kova Burcu Günlük Aşk & İlişkiler Yorumu", "" + ask));
                    models.add(new Model(R.drawable.kova, "Kova Burcu Maddi Durum Yorumu", "" + maddi));
                    models.add(new Model(R.drawable.kova, "Kova Burcu Günlük Kariyer Yorumu", "" + kariyer));
