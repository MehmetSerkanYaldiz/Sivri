...
public class Aslan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        aslanAdview = findViewById(R.id.aslanAdView);
    ...
    public void istek() {
        ...
        dialog.show();
        Call<Bilgiler> aslanBilgiList = ManagerAll.getInstance().aslanBilgileri();
        aslanBilgiList.enqueue(new Callback<Bilgiler>() {
            @Override
            public void onResponse(Call<Bilgiler> call, Response<Bilgiler> response) {
                if (response.isSuccessful()) {
                    ...
                    models.add(new Model(R.drawable.aslan, "Aslan Burcu Günlük  Genel Yorum", "" + genel));
                    models.add(new Model(R.drawable.aslan, "Aslan Burcu Günlük Aşk & İlişkiler Yorumu", "" + ask));
                    models.add(new Model(R.drawable.aslan, "Aslan Burcu Maddi Durum Yorumu", "" + maddi));
                    models.add(new Model(R.drawable.aslan, "Aslan Burcu Günlük Kariyer Yorumu", "" + kariyer));
